...
export default function ProductCard({ product, showroomName, categoryName, onCompareToggle, isCompared }: ProductCardProps) {
  ...
  return (
    <motion.div
      ...
      className={`cursor-pointer group flex flex-col bg-white border ${isCompared ? 'border-amber-500 shadow-md shadow-amber-500/10' : 'border-stone-200/60 hover:shadow-lg'} rounded-3xl overflow-hidden transition-all duration-300 transform`}
    >
      {/* Product Image Stage */}
