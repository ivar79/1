      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden bg-stone-900">
        ...
        >
          ...
          >
            ...
            <span>{settings.home_hero_badge || "پلتفرم تخصصی مقایسه و مشاوره مبلمان لوکس"}</span>
          </motion.div>
          ...
          >
            {settings.home_hero_title || "مبلمان لوکس؛ خرید مطمئن، با شرایط اقساطی"}
          </motion.h1>
          ...
          >
            {settings.home_hero_desc || "ما در انتخاب بهترین مبلمان همراه شما هستیم. مشاوره‌ی تخصصی، مقایسه‌ی برندهای معتبر و تضمین بهترین شرایط قیمتی برای خلق خانه‌ای رویایی."}
          </motion.p>
          ...
          >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="w-full sm:w-auto bg-[#2AABEE]/90 hover:bg-[#2AABEE] border border-[#2AABEE]/50 text-white px-6 sm:px-8 py-3.5 sm:py-4 rounded-2xl text-sm sm:text-base font-medium transition-all flex items-center justify-center gap-2 backdrop-blur-sm"
            >
              <span>مشاوره رایگان اختصاصی در تلگرام</span>
            </a>
          </motion.div>
        </div>
      </section>
